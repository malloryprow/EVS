#PBS -N jevs_global_det_atmos_graphcastgfs13_test_grid2grid_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDMAIL=NO
export KEEPDATA=YES
export job=${PBS_JOBNAME:-jevs_global_det_atmos_graphcastgfs13_test_grid2grid_stats}
...
#          atmospheric grid-to-grid component for GraphcastGFS - 13 levels
######################################################################
