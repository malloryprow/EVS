#PBS -N jevs_global_det_atmos_graphcastgfs13_grid2grid_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDMAIL=NO
export KEEPDATA=YES
export job=${PBS_JOBNAME:-jevs_global_det_atmos_graphcastgfs13_grid2grid_stats}
...
export MODELNAME=graphcastgfs13
