#PBS -N jevs_global_det_graphcastgfs_atmos_grid2grid_pres_levs_plots_90days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export KEEPDATA=YES
export SENDDBN=NO
export job=${PBS_JOBNAME:-jevs_global_det_graphcastgfs_atmos_grid2grid_pres_levs_plots_90days}
...
# Set config file
export config=$HOMEevs/parm/evs_config/global_det/config.evs.${STEP}.${COMPONENT}.${RUN}.${VERIF_CASE}.${VERIF_TYPE}.graphcastgfs
echo $config
