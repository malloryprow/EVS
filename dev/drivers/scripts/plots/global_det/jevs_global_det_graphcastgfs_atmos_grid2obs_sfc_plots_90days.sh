#PBS -N jevs_global_det_graphcastgfs_atmos_grid2obs_sfc_plots_90days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export KEEPDATA=YES
export SENDDBN=NO
export job=${PBS_JOBNAME:-jevs_global_det_graphcastgfs_atmos_grid2obs_sfc_plots_90days}
